...
Img_gaussian_1 = medfilt2(Img_gaussian_0, [5 5]);%median
...
Img_salt_1 = medfilt2(Img_salt_0, [5 5]);%median
...
Img_speckle_1 = medfilt2(Img_speckle_0, [5 5]);%median
...
Img_speckle_1=mat2gray(Img_speckle_1);
 ...
 title('gaussian noise after median filter');
 subplot(2,3,2);
 imshow(Img_salt_0);
 title('salt&pepper noise');
 subplot(2,3,5);
 imshow(Img_salt_1);
 title('salt&pepper noise after median filter');
 subplot(2,3,3);
 imshow(Img_speckle_0);
 title('speckle noise');
 subplot(2,3,6);
 imshow(Img_speckle_1);
 title('speckle noise after median filter');
 suptitle('denoise with median filter');